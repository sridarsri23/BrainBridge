...
export default function JobMatchCard({ match }: JobMatchCardProps) {
  const applyJobMutation = useApiMutation(
    "POST", 
    `/api/jobs/${match.job?.jobId}/apply`,
    {
      successTitle: "Application Submitted",
      successDescription: "Your application has been submitted successfully!",
      errorTitle: "Error",
      errorDescription: "Failed to submit application. Please try again."
    }
  );

  const saveJobMutation = useApiMutation(
    "POST", 
    `/api/jobs/${match.job?.jobId}/save`,
    {
      successTitle: "Job Saved",
      successDescription: "Job has been saved to your favorites."
    }
  );
